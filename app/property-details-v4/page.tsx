                ...
                <div className="col-lg-12">
                  <div className="images-area-details">
                    <Slider {...settings1} className="img3-carousel">
                      ...
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img39.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img40.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img41.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img42.png"
                        alt="Estatezy"
                      />
                    </Slider>
                    ...
                    <Slider {...settings2} className="img4">
                      ...
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img43.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img44.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img45.png"
                        alt="Estatezy"
                      />
                      <img
                        src="/assets/img/all-images/properties/property-img46.png"
                        alt="Estatezy"
                      />
                    </Slider>
                  </div>
