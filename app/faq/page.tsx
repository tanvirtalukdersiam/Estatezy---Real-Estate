                    ...
                    <div className="accordion" id="accordionExample">
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          ...
                          >
                            How do I start looking for a home on Estatezy?
                          </button>
                        </h2>
                        <div
                          id="collapseOne"
                    ...
                    <div className="accordion" id="accordionExample2">
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          ...
                          >
                            How do I list my property on Estatezy?
                          </button>
                        </h2>
                        <div
                          id="collapseSix"
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          ...
                          >
                            What are the benefits of selling with Estatezy?
                          </button>
                        </h2>
                        <div
                          id="collapseSeven"
                    ...
                    <div className="accordion" id="accordionExample3">
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          ...
                          >
                            How do I find rental properties on Estatezy?
                          </button>
                        </h2>
                        <div
                          id="collapse11"
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              For managed properties, contact our support team,
