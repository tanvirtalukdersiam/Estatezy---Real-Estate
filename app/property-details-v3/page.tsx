                  ...
                  <div className="images-area-details">
                    <div className="row">
                      <div className="col-lg-6">
                        <Swiper
                          {...swiperOptions2}
                          className="img2-carousel owl-carousel mb-4"
                        >
                          <SwiperSlide>
                            <img
                              src="/assets/img/all-images/properties/property-img35.png"
                              alt="Estatezy"
                            />
                          </SwiperSlide>
                          <SwiperSlide>
                        ...
                        <div className="row">
                          <div className="col-lg-6 col-md-6">
                            <div className="img1">
                              <img
                                src="/assets/img/all-images/properties/property-img36.png"
                                alt="Estatezy"
                              />
                            </div>
                          </div>
                          <div className="col-lg-6 col-md-6">
                            <div className="img1">
                              <img
                                src="/assets/img/all-images/properties/property-img37.png"
                                alt="Estatezy"
                              />
                              <VideoPopup />
                            </div>
                      ...
                      <div className="col-lg-6">
                        ...
                        <div className="images-area2">
                          <div className="img1">
                            <img
                              src="/assets/img/all-images/properties/property-img38.png"
                              alt="Estatezy"
                            />
                          </div>
