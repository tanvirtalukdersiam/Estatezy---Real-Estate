...
export default function Footer4() {
  return (
    <>
      <div
        className="footer4-section-area"
        style={{
          ...
          <div className="row">
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="footer-widget-section">
                        <div className="img1">
                          <img
                            src="/assets/img/all-images/others/others-img6.png"
                            alt="Estatezy"
                          />
                        </div>
                        <div className="pera">
                          ...
                          <p>
                            Discover all you need for purchasing, selling, and{" "}
                            <br className="d-lg-block d-none" /> renting
                            property with the new
                            <span>Estatezy App!</span>
                          </p>
                        </div>
                        <ul>
                          <li>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-logoarea">
                <img src="/assets/img/logo/logo5.png" alt="Estatezy" />
                <div className="space24" />
                <p>
                  As Estatezy’s lead negotiator, Chris brings years of
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-content">
                ...
                <ul>
                  ...
                  <li>
                    <Link href="/property-halfmap-list">Properties</Link>
                  </li>
                  <li>
