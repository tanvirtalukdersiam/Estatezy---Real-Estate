...
export default function Items3() {
  ...
  return (
    <>
      <div
        className="items3-section-area sp1"
        style={{
          ...
          <div className="row">
            ...
            >
              <div className="cs_case_study_1_list">
                <div
                  className={`cs_case_study cs_style_1 cs_hover_active aos-init aos-animate ${
                ...
                >
                  <Link
                    ...
                    data-src="/assets/img/all-images/items/item-img2.png"
                  />
                ...
                >
                  <Link
                    ...
                    data-src="/assets/img/all-images/items/item-img3.png"
                  />
                  <div className="content-area">
                    <Link href="/property-details-v1" className="head">
                      The Parkview Residence
                ...
                >
                  <Link
                    ...
                    data-src="/assets/img/all-images/items/item-img4.png"
                  />
                  <div className="content-area">
                    <Link href="/property-details-v1" className="head">
                      The Parkview Residence
