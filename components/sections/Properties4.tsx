...
export default function Properties4() {
  return (
    <>
      <div
        className="properties4-section-area sp2"
        style={{
                      ...
                      <div className="row">
                            ...
                            <div className="img1 image-anime">
                              ...
                              >
                                <div className="swiper-wrapper">
                                  <SwiperSlide>
                                    <img
                                      src="/assets/img/all-images/properties/property-img19.png"
                                      alt="Estatezy"
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide>
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="property-single-boxarea">
                            <div className="img1 image-anime">
                              <img
                                src="/assets/img/all-images/properties/property-img20.png"
                                alt="Estatezy"
                              />
                            </div>
                            <ul className="category-list">
                            ...
                            <div className="img1 image-anime">
                              ...
                              >
                                <div className="swiper-wrapper">
                                  <SwiperSlide>
                                    <img
                                      src="/assets/img/all-images/properties/property-img21.png"
                                      alt="Estatezy"
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide>
                            ...
                            <div className="img1 image-anime">
                              ...
                              >
                                <div className="swiper-wrapper">
                                  <SwiperSlide>
                                    <img
                                      src="/assets/img/all-images/properties/property-img22.png"
                                      alt="Estatezy"
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide>
                            ...
                            <div className="img1 image-anime">
                              ...
                              >
                                <div className="swiper-wrapper">
                                  <SwiperSlide>
                                    <img
                                      src="/assets/img/all-images/properties/property-img23.png"
                                      alt="Estatezy"
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide>
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="property-single-boxarea">
                            <div className="img1 image-anime">
                              <img
                                src="/assets/img/all-images/properties/property-img24.png"
                                alt="Estatezy"
                              />
                            </div>
                            <ul className="category-list">
