...
export default function Hero3() {
  return (
    <>
      <div
        className="hero3-section-area"
        style={{
          backgroundImage: "url(assets/img/all-images/bg/hero-bg3.png)",
      ...
      >
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="hero3-header">
                ...
                <h1>
                  How to Sell Home <br /> <span className="word" />
                </h1>
              </div>
            </div>
          </div>
        </div>
        <div className="main-imagesarea">
          <div className="img1 aniamtion-key-2">
            <img
              src="/assets/img/all-images/hero/hero3-img1.png"
              alt="Estatezy"
            />
          </div>
          <div className="img2">
            <img src="/assets/img/elements/bottom-img2.png" alt="Estatezy" />
          </div>
        </div>
        <div className="img3">
          <img src="/assets/img/elements/bottom-img1.png" alt="Estatezy" />
        </div>
        {/*===== OTHERS AREA STARTS =======*/}
        <div className="others-section-area3">
          <div className="container">
            <div className="row">
              <div className="col-lg-12">
                ...
                <div className="property-tab-section search-filter-form">
                  <div className="tab-header">
                    ...
                    <button className="tab-btn" data-tab="for-rent">
                      For Rent
                    </button>
                  </div>
                  <div className="tab-content1" id="for-sale">
                    <div className="filters">
                      ...
                      <div className="filter-group">
                        ...
                        <button
                          id="customize-sale"
                          className="customize-sale show-form"
                        >
                          Advance{" "}
                          <span className="icon">
                            <svg
                    ...
                    <div className="group-price">
                      <div className="slider-item">
                        <div className="slider-label">
                          Price Range:{" "}
                          <span id="price-output">$200 - $2,500,000</span>
                        </div>
                      ...
                      <div className="slider-item">
                        <div className="slider-label">
                          Size Range:{" "}
                          <span id="size-output">146 SqFt - 448 SqFt</span>
                        </div>
        ...
        <div className="villa-listing">
          ...
          <div className="villa-images">
            <div className="img1">
              <img
                src="/assets/img/all-images/others/others-img4.png"
                alt="Estatezy"
              />
            </div>
            <div className="text">
        ...
        <div className="villa-listing2">
          ...
          <div className="villa-images">
            <div className="img1">
              <img
                src="/assets/img/all-images/others/others-img5.png"
                alt="Estatezy"
              />
            </div>
            <div className="text">
              <Link href="/property-details-v1">Jaksan Villa</Link>
              <div className="space10" />
              <p>$1.800,000</p>
            </div>
          </div>
